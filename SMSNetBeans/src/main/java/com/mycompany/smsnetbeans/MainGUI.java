...
public class MainGUI extends JFrame {
    ...
    public void initComponents(){
        ...
        btnCourses.addActionListener(e -> manageCourses());
        btnStudents.addActionListener(e -> manageStudents());
        btnTeachers.addActionListener(e -> manageTeachers());
    ...
    new CourseGUI(); // Opens the Manage Courses window
}
